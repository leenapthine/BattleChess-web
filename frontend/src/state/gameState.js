...
export const [pieces, setPieces] = createSignal([
  ...
  { id: 12, type: "YoungWiz", color: "White", row: 1, col: 3, pawnLoaded: false, stunned: false, raisesLeft: 0, pieceLoaded: null, isStone: false },
  { id: 13, type: "YoungWiz", color: "White", row: 1, col: 4, pawnLoaded: false, stunned: false, raisesLeft: 0, pieceLoaded: null, isStone: false },
  { id: 14, type: "YoungWiz", color: "White", row: 1, col: 5, pawnLoaded: false, stunned: false, raisesLeft: 0, pieceLoaded: null, isStone: false },
  { id: 15, type: "YoungWiz", color: "White", row: 1, col: 6, pawnLoaded: false, stunned: false, raisesLeft: 0, pieceLoaded: null, isStone: false },
  { id: 16, type: "YoungWiz", color: "White", row: 1, col: 7, pawnLoaded: false, stunned: false, raisesLeft: 0, pieceLoaded: null, isStone: false },
